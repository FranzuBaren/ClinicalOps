...
<p align="center">
  <a href="AI_ClinOps.ipynb">📓 Notebook</a> · 
  <a href="ClinOps_AI.pdf">📄 Technical Report (14pp, LaTeX)</a> · 
...
clinicalops/
│
├── AI_ClinOps.ipynb              # Complete pipeline (69 cells, 9 figures)
├── ClinOps_AI.pdf                # Technical report (14 pages, JCDE-style LaTeX)
├── ClinOps_AI.tex                # LaTeX source (compilable)
│
...
├── requirements.txt
├── LICENSE                       # MIT
├── CITATION.cff                  # GitHub "Cite this repo"
├── CHANGELOG.md
├── CONTRIBUTING.md
└── CODE_OF_CONDUCT.md
```
...
The accompanying [LaTeX report](ClinOps_AI.pdf) (14 pages, JCDE journal style) includes:
...
<p align="center">
  <sub>Built by Francesco Orsi · Python, PyTorch, and honest methodology · MIT License</sub>
</p>
